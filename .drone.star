...
KUBECTL_IMAGE = "docker.io/bitnami/kubectl:1.31"
...
def main(ctx):
    ...
    pipeline_docs[0]["depends_on"].append(pipeline_lint[0]["name"])
    ...
    return pipeline_lint + pipeline_docs + pipeline_kubernetes + pipeline_deployments + pipeline_release
